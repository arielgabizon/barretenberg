...
inline void add_grand_product_commitments_to_buffer(const plonk_proof<program_width> &proof, uint64_t* input_buffer)
{
...
inline void add_quotient_commitment_to_buffer(const plonk_proof<program_width> &proof, uint64_t* input_buffer)
{
...
inline void add_polynomial_evaluations_to_buffer(const plonk_proof<program_width> &proof, const barretenberg::fr::field_t& t_eval, uint64_t* input_buffer)
{
    for (size_t i = 0; i < program_width; ++i) {
        barretenberg::fr::__from_montgomery_form(proof.w_l_eval, *(barretenberg::fr::field_t*)&input_buffer[i*4]);
    }
    barretenberg::fr::__from_montgomery_form(proof.sigma_1_eval, *(barretenberg::fr::field_t*)&input_buffer[program_width * 4]);
    barretenberg::fr::__from_montgomery_form(proof.sigma_2_eval, *(barretenberg::fr::field_t*)&input_buffer[(program_width + 1)* 4]);
    barretenberg::fr::__from_montgomery_form(proof.z_1_shifted_eval, *(barretenberg::fr::field_t*)&input_buffer[(program_width + 2)* 4]);
    barretenberg::fr::__from_montgomery_form(proof.linear_eval, *(barretenberg::fr::field_t*)&input_buffer[(program_width + 3)* 4]);
    barretenberg::fr::__from_montgomery_form(t_eval, *(barretenberg::fr::field_t*)&input_buffer[(program_width + 4)* 4]);
}

inline void add_kate_elements_to_buffer(const plonk_proof<program_width> &proof, uint64_t* input_buffer)
{
...
inline barretenberg::fr::field_t compute_gamma(const plonk_proof<program_width> &proof)
{
...
inline barretenberg::fr::field_t compute_beta(const plonk_proof<program_width> &proof, const barretenberg::fr::field_t &alpha)
{
...
inline barretenberg::fr::field_t compute_alpha(const plonk_proof<program_width> &proof)
{
...
inline barretenberg::fr::field_t compute_evaluation_challenge(const plonk_proof<program_width> &proof)
{
...
inline barretenberg::fr::field_t compute_kate_separation_challenge(const plonk_proof<program_width> &proof, const barretenberg::fr::field_t &t_eval)
{
